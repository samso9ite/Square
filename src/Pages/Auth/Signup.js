...
const Register = () => {
    ...
    const handleSubmit = (event) => {
        ...
        .then(res => {
            ...
            toast('🦄 An Activation Link Has Been Sent To Your Email!', {
                position: "top-right",
                autoClose: 5000,
            ...
            <div className="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                ...
                <div className="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div className="intro-x mt-8">
                        ...
                        <input type="text" className="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Password" name="password"  value={inputs.password || ''} onChange={handleChange}/>
                        ...
                        <input type="text" className="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Password Confirmation" name="re_password"  value={inputs.re_password || ''} onChange={handleChange}/>
                    </div>
