        ...
        <div className="block xl:grid grid-cols-2 gap-4">
            ...
            <div className="hidden xl:flex flex-col min-h-screen">
                <a href="" className="-intro-x flex items-center pt-5">
                    <img alt="Square" className="w-6" src={require("../../assets/images/logo.svg").default}/>
                ...
                <div className="my-auto">
                    ...
                    <div className="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400"> We're ready to process your request.</div>
                </div>
            </div>
            {/* <!-- END: Login Info -->
            <!-- BEGIN: Login Form --> */}
